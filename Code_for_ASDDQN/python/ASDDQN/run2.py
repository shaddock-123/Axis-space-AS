...
from cartpole_model2 import CartpoleModel2
...
def main():
    ...
    while episode < max_episode:
        ...
        episode +=1
        sheet4.write(1,0,episode)
        sheet4.write(1,1,eval_reward)
