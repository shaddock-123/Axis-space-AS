...
from cartpole_model5 import CartpoleModel5
from cartpole_agent import CartpoleAgent
from parl.algorithms import DQN,DDQN
from env5 import ArmEnv5
...
def main():
    ...
    agent.restore('./model_TRAIN_5.ckpt')
    ...
    while episode <max_episode:
        ...
        for i in range(50):
            ...
            save_path = './model_TRAIN_EPISODE_5.ckpt'
            agent.save(save_path)
