...
from cartpole_model6 import CartpoleModel6
from cartpole_agent import CartpoleAgent
from parl.algorithms import DQN,DDQN
from env6 import ArmEnv6
...
wb5=xlwt.Workbook()
sheet5=wb5.add_sheet('totalstepe&trainrewards')
text5 = ["totalstep","reward"]
for i in range(len(text5)):
    sheet5.write(0,i,text5[i])
...
def run_train_episode(agent, env, rpm):
    ...
    while True:
        ...
        sheet5.write(total_step,0,total_step)
        sheet5.write(total_step,1,reward)
        wb5.save('total_step111&train_reward.xls')
        save_path = './model_TRAIN_6.ckpt'
       ...
       # print(reward)
        ...
        #if step > 50:
        #    done = True
            #sheet1.write(total_step+101,0,total_step)
            #sheet1.write(total_step+101,1,reward)
            #wb1.save('total_step&train_reward.xls')
        if done:
            break
    return total_reward
...
def main():
    ...
    while episode <max_episode:
        ...
        for i in range(50):
            ...
            save_path = './model_TRAIN_EPISODE_6.ckpt'
            agent.save(save_path)
