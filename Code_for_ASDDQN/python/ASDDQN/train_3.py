...
from cartpole_model3 import CartpoleModel3
...
def main():
    ...
    while episode < max_episode:
        ...
        for i in range(50):
            ...
            save_path = './model_TRAIN_EPISODE_3.ckpt'
            agent.save(save_path)
